          ...
          <el-form-item class="input" label="景点地址" prop="jingdiandizhi">
              <el-input v-model="ruleForm.jingdiandizhi" 
                placeholder="景点地址" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="门票" prop="menpiao">
          <el-select v-model="ruleForm.menpiao" placeholder="请选择门票">
            <el-option
                v-for="(item,index) in menpiaoOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.zhaopian" label="照片" prop="zhaopian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.zhaopian.split(',')" :src="item" width="100" height="100">
                                                                                ...
                                                                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="景点特色" prop="jingdiantese">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="景点特色"
                  v-model="ruleForm.jingdiantese" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jingdiantese" label="景点特色" prop="jingdiantese">
                    <span>{{ruleForm.jingdiantese}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.jingdianjieshao = this.ruleForm.jingdianjieshao.replace(reg,'../../../ssmd758h/upload');
        } else {
          this.$message.error(data.msg);
        }
      });

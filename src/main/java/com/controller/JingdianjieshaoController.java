...
public class JingdianjieshaoController {
    ...
    public R info(@PathVariable("id") Long id){
		...
		jingdianjieshao.setClicknum(jingdianjieshao.getClicknum()+1);
		jingdianjieshao.setClicktime(new Date());
    ...
    public R autoSort(@RequestParam Map<String, Object> params,JingdianjieshaoEntity jingdianjieshao, HttpServletRequest request,String pre){
        EntityWrapper<JingdianjieshaoEntity> ew = new EntityWrapper<JingdianjieshaoEntity>();
